...
public class Douyatech {
	...
	public boolean exist(String name) {
		...
		Cursor cursor=db.query("deviceinfo", null, "devicename=?", new String[]{name}, null, null, null);
	...
	public boolean isExist(String tableName,String nameID){
		...
		SQLiteDatabase db = helper.getReadableDatabase();
		Cursor cursor=db.rawQuery("select * from "+tableName+" where name_id=?",new String[]{nameID});
